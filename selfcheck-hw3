...
#	link to tests:
testsurl="https://webcourse.cs.technion.ac.il/fc159753hw_236360_202202/hw/WCFiles/X2363602022011-hw3-tests.zip"
makefileurl="https://webcourse.cs.technion.ac.il/fc159753hw_236360_202202/hw/WCFiles/X2363602022011-Makefile"
#	number of tests: 
numtests=2 
...
wget -O Makefile --no-check-certificate "$makefileurl" &> /dev/null
if [ ! -f Makefile ]
	then
